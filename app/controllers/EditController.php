    ...
    public function payload()
    {
        ...
        if (isset($_POST['edt_payload'])) :
            ...
            elseif (empty($nome)) :
                ...
                $sql = $conn->prepare("UPDATE payloads SET Name='$nome', FLAG='$flag', Payload='$flag', SNI='$payload', TlsIP='$tlsip', ProxyIP='$proxyip', ProxyPort='$proxyport', Info='$info' WHERE id='$id'");
                $sql->execute();
